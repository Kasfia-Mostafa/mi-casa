...
const Offered = () => {
  ...
  const { property_location, property_price, property_title, agent_name } =
    OfferedProperty || [];
    ...
    const handleOfferedPrice = (event) => {
      ...
      const offerInfo = {
       title,location,aName,price,bName,bEmail,date
      };
            ...
            <form onSubmit={handleOfferedPrice} className="card-body h-full">
             ...
             <div className="form-control grid">
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text text-lg">Property Location</span>
                </label>
                <input
                  name="location"
              ...
              <div className="form-control mt-6 flex items-center">
                <button className="btn w-60 text-white text-lg bg-gradient-to-r from-emerald-800 to-emerald-300">Offer Now</button>
              </div>
            </form>
          </div>
        </div>
